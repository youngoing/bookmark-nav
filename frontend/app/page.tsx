...
import { Archive, ArrowUpRight, BarChart3, Bookmark, Check, ChevronLeft, ChevronRight, Clock3, Compass, Copy, Download, FolderOpen, Globe2, KeyRound, LayoutGrid, Link2, List, LogOut, Menu, Monitor, Moon, Pencil, Plus, Search, Settings2, Share2, SlidersHorizontal, Star, Sun, Table2, Trash2, X } from "lucide-react";
